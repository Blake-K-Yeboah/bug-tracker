...
const Legend = ({ values }: PropsI) => {
    ...
    const percentageValues = Object.values(values).map(
        (value) => Math.round((value / total) * 1000) / 10
    ); // Round to one decimal place for ease of reading
        ...
        <div className="legend">
            ...
            <div className="pair">
                ...
                <span className="value">
                    Not Started {total > 0 ? `(${percentageValues[0]}%)` : ""}
                </span>
            </div>
            ...
            <div className="pair">
                ...
                <span className="value">
                    In Progress {total > 0 ? `(${percentageValues[1]}%)` : ""}
                </span>
            </div>
            ...
            <div className="pair">
                ...
                <span className="value">
                    Completed {total > 0 ? `(${percentageValues[2]}%)` : ""}
                </span>
            </div>
        </div>
    );
